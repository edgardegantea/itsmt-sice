...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    label: 'Horarios',
    items: [
      { to: '/admin/horarios/builder',           label: 'Builder de Horarios',    roles: ['superadmin', 'admin', 'jefe_carrera', 'director_academico', 'control_escolar', 'direccion_general', 'direccion_academica', 'subdireccion_academica'] },
      { to: '/admin/horarios/disponibilidad',    label: 'Disponibilidad (admin)',  roles: ['superadmin', 'admin', 'jefe_carrera'] },
