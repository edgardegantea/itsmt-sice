  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Libro de Registro NC</h1>
          <p className="text-sm text-slate-500 mt-1">
            Genera el libro de registro de números de control en formato PDF (TecNM-AC-PO-001)
          </p>
        </div>
        <button
          onClick={descargar}
      ...
      <div className="bg-white rounded-xl shadow border border-slate-200 p-8">
        <div className="flex flex-col items-center justify-center gap-4 py-8 text-slate-400">
          ...
          <p className="text-sm text-center max-w-sm">
            El Libro de Registro NC contiene el listado completo de alumnos inscritos con su número de control,
            datos personales y carrera. Haz clic en <strong>Descargar PDF</strong> para generar el documento.
          </p>
        </div>
      </div>
    </div>
