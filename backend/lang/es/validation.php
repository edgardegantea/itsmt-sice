...
return [
    ...
    'password'             => [
        ...
        'uncompromised' => 'La contraseña ingresada ha aparecido en filtraciones de datos. Por favor elige una contraseña diferente.',
    ],
    ...
    */
    'attributes' => [
        ...
        'escuela_bachillerato'             => 'escuela de bachillerato',
        'promedio_bachillerato'            => 'promedio de bachillerato',
        'turno_preferido'                  => 'turno preferido',
        'email'                            => 'correo electrónico',
        'telefono'                         => 'teléfono',
        'folio_preinscripcion_tecnm'       => 'folio de preinscripción TecNM',
        'folio_exani'                      => 'folio EXANI-II',
        'puntaje_exani'                    => 'puntaje EXANI-II',
        ...
        'estatus'                          => 'estatus',
        'autorizacion_consulta_expediente' => 'autorización de consulta de expediente',
        'semestre_actual'                  => 'semestre actual',
        'numero_control'                   => 'número de control',
        'pendiente_certificado_bachillerato' => 'certificado de bachillerato',
        'observaciones_estatus'            => 'observaciones de estatus',
        ...
        // Académico
        'clave'                            => 'clave',
        'clave_oficial_tecnm'              => 'clave oficial TecNM',
        'nombre'                           => 'nombre',
        'semestre'                         => 'semestre',
        'creditos'                         => 'créditos',
        ...
        // Periodos / Carreras
        'codigo_it'                        => 'código IT',
        'plan_clave'                       => 'clave del plan',
        'especialidad'                     => 'especialidad',
        'activa'                           => 'activa',
        'fecha_inicio_inscripciones'       => 'fecha de inicio de inscripciones',
        'fecha_fin_inscripciones'          => 'fecha de fin de inscripciones',
        'fecha_inicio_clases'              => 'fecha de inicio de clases',
        'fecha_fin_clases'                 => 'fecha de fin de clases',
