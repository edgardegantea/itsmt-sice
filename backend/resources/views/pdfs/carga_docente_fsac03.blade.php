...
for ($h = 7; $h < 21; $h++) { $slots[]=sprintf('%02d:00', $h); } // Construir mapa slot × día → etiqueta (grupo-aula)
    ...
    if ($slotMin >= $inicioMin && $slotMin < $finMin) { $horarioGrid[$slot][$h->dia_semana] = $etiqueta;
        }
        }
        }
        }
        ...
        <body style="padding:8mm 10mm;">
                    ...
                    <td rowspan="2" style="width:35%; vertical-align:top; padding:2px 4px;">
                        ...
                        <table style="width:100%; border-collapse:collapse; margin-top:2px;">
                            <tr>
                                ...
                                <td style="text-align:right; font-weight:bold; padding:2px 3px; font-size:8pt;">
                                    {{ $totalHorasGrupo }}</td>
                            </tr>
                            <tr style="background:#eef;">
                                <td style="font-size:6pt; padding:2px 3px; font-weight:bold;">Total</td>
                                <td
                                    style="text-align:right; font-weight:bold; padding:2px 3px; font-size:9pt; color:#00529B;">
                                    {{ $totalHorasGrupo }}</td>
                            </tr>
                        </table>
                    </td>
            ...
            <table class="carga-table">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="6" style="text-align:center; color:#999; padding:6px;">Sin asignaturas asignadas.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
