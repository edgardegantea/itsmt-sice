...
class ConfiguracionController extends Controller
{
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        $datos = $request->validate([
            ...
            'color_acento'                     => ['sometimes', 'string', 'regex:/^#[0-9a-fA-F]{6}$/'],
            'color_sidebar'                    => ['sometimes', 'nullable', 'string', 'regex:/^#[0-9a-fA-F]{6}$/'],
            'radio_bordes'                     => ['sometimes', 'string', 'in:cuadrado,moderado,redondeado,pill'],
